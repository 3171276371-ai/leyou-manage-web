      ...
      <template slot="items" slot-scope="props">
        ...
        <td class="justify-center layout px-0">
          ...
          <v-btn
            ...
            @click="editSaleable(props.item.id,props.item.saleable)"
          >下架</v-btn>
          <v-btn icon v-else @click="editSaleable(props.item.id,props.item.saleable)">上架</v-btn>
        </td>
      </template>
    </v-data-table>
    <!--弹出的对话框-->
...
export default {
  ...
  methods: {
    ...
    editSaleable(id, saleable) {
      if (saleable == true) {
        this.$http({
          method: "put",
          url: "/item/spu/updateSaleable",
